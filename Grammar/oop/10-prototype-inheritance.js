...
// log("subObj.subValue => ", subObj.subValue); // sub
// log("subObj.superValue => ", subObj.superValue); // super
// // subObj에서 subValue를 찾아보고, 없으면 __proto__로 연결된 superObj에서 찾아봄 -> 있으면 리턴!
subObj.superValue = "sub2";
// log("subObj.superValue => ", subObj.superValue); // sub2
// log("superObj.superValue => ", superObj.superValue); // super
